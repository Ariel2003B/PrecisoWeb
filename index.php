...
<head>
    ...
    <title>PrecisoGPS</title>
    <!-- Favicon-->
    <link rel="icon" type="image/x-icon" href="assets/img/logoPreciso.jpg" />
...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="" href="#page-top">
                <img src="assets/img/PrecisNavidad.png" alt="Preciso GPS" />
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link" href="ClientsAccess.html">Acceso clientes</a></li>
                    <li class="nav-item"><a class="nav-link" href="#services">Servicios</a></li>
                    <!-- <li class="nav-item"><a class="nav-link" href="#portfolio">Plataforma</a></li> -->
                    <li class="nav-item"><a class="nav-link" href="#portfolio">Planes</a></li>
                    <li class="nav-item"><a class="nav-link" href="#about">Nosotros</a></li>
                    <li class="nav-item"><a class="nav-link" href="#contact">Contactanos</a></li>

                    <li class="nav-item"><a class="nav-link" href="policyandprivacy.html">Política de privacidad</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <!-- <header class="masthead">
        ...
        <div class="container">
            <div class="masthead-subheading">Supervisa tus vehículos en tiempo real y asegura un control
                total en cualquier lugar y momento.</div>
            <div class="masthead-heading text-uppercase">PROTECCIÓN Y MONITOREO CONSTANTE</div>
            <a class="btn btn-primary btn-xl text-uppercase" href="#services">CONOCE NUESTROS PLANES</a>
        </div>
    </header> -->
    <header class="masthead">
        <!-- <video autoplay muted loop class="masthead-video">
        ...
        <video autoplay muted loop class="masthead-video">
            <source src="/assets/img/FondoNavidad.mp4" type="video/mp4">
            Tu navegador no soporta la reproducción de video.
        </video>
        ...
        <div class="container masthead-content">
            ...
            <a id="contador-visitas" class="btn btn-contador btn-xl text-uppercase" href="#">Cargando visitantes...</a>
        </div>
                ...
                <div class="col-lg-6 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/precisoSatelital.jpg" alt="GPS Pro" />
                        </a>
                ...
                <div class="col-lg-6 col-sm-6 mb-4">
                    ...
                    <div class="portfolio-item">
                        <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal2">
                            ...
                            <img class="img-fluid" src="assets/img/portfolio/precisoSatelital2.png" alt="GPS Básico" />
                        </a>
                        <div class="portfolio-caption">
                ...
                <div class="carousel-inner text-center">
                    <div class="carousel-item active">
                        <div class="d-flex justify-content-center align-items-center">
                            <img src="assets/img/clients/Kinara.jpg" alt="Logo Kinara">
                            <img src="assets/img/clients/quitumbe.png" alt="Logo Quitumbe">
                            <img src="assets/img/clients/Transporsel.jpg" alt="Logo TransporSel">
                            <img src="assets/img/clients/Transalfa.jpg" alt="Logo Transalfa">
                            <img src="assets/img/clients/teleferico.png" alt="Logo Teleferico">
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="d-flex justify-content-center align-items-center">
                            <img src="assets/img/clients/Sirena.jpg" alt="Logo Sirena">
                            <img src="assets/img/clients/Rutvitransa.png" alt="Logo Rutvitransa">
                            <img src="assets/img/clients/xtrim.png" alt="Logo Xtrim tv cable">
                        </div>
                    </div>
                    <div class="carousel-item">
                        <div class="d-flex justify-content-center align-items-center">
                            <img src="assets/img/clients/Rapitrans.jpg" alt="Logo Rapitrans">
                        </div>
                    </div>
                </div>
                <!-- Controles -->
                ...
                <div class="row align-items-stretch mb-5">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback" data-sb-feedback="name:required">Es requerido su nombre.</div>
                        </div>
                        <div class="form-group">
                            <!-- Email address input-->
                            ...
                            <div class="modal-body text-center">
                                ...
                                <div class="img-container">
                                    <img class="img-fluid d-block mx-auto rounded shadow"
                                        src="assets/img/portfolio/precisoSatelital.jpg" alt="GPS Pro"
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body text-center">
                                ...
                                <div class="img-container">
                                    <img class="img-fluid d-block mx-auto rounded shadow"
                                        src="assets/img/portfolio/precisoSatelital2.png" alt="GPS Básico"
                                        style="width: 60%; border: 3px solid #ffc800;" />
                                </div>
                                <!-- Características principales -->
                                <div class="features mt-4">
    ...
    <script>document.addEventListener("DOMContentLoaded", function () {
            ...
            dropdowns.forEach(dropdown => {
                dropdown.addEventListener('click', function (e) {
                    e.stopPropagation(); // Evita que el evento de clic cierre el menú colapsable
                });
            });
        });
...
<script>
    fetch('contador.php')
        ...
        .then(visitas => {
            document.getElementById('contador-visitas').innerText = `Tú eres el visitante número ${visitas} de PrecisoGPS`;
        })
        .catch(error => {
