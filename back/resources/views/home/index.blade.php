...
@section('content')
    ...
    <div class="modal fade" id="tiktokModal" tabindex="-1" aria-labelledby="tiktokModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <img src="{{ asset('img/precisoimg/promoGps.jpeg') }}" alt="PrecisoGPS" style="width: 100%; height: auto;"
                        class="img-fluid">
                </div>
    ...
    <a href="https://wa.me/593981491469?text=Hola%2C%20me%20interesa%20asesoramiento%20sobre%20el%20rastreo%20vehicular.%20¿Podrías%20darme%20más%20información%3F"
